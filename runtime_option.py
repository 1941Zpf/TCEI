...
def runtime_option():
    ...
    # For TCEI
    parser.add_argument("--pos-enabled", type=str)
    parser.add_argument("--pos-shot-capacity", type=int)
    parser.add_argument("--pos-alpha", type=float)
    parser.add_argument("--pos-beta", type=float)

    parser.add_argument("--neg-enabled", type=str)
    parser.add_argument("--neg-shot-capacity", type=int)
    parser.add_argument("--neg-alpha", type=float)
    parser.add_argument("--neg-beta", type=float)
    parser.add_argument("--neg-entropy-threshold-lower", type=float)
    parser.add_argument("--neg-entropy-threshold-upper", type=float)
    parser.add_argument("--neg-mask-threshold-lower", type=float)
    parser.add_argument("--neg-mask-threshold-upper", type=float)
    parser.add_argument("--pos-temperature", type=float)
    parser.add_argument("--neg-temperature", type=float)

    # For TCEI-WIDE
    parser.add_argument("--w-pos-enabled", type=str)
    parser.add_argument("--w-pos-shot-capacity", type=int)
    parser.add_argument("--w-pos-alpha", type=float)
    parser.add_argument("--w-pos-beta", type=float)

    parser.add_argument("--w-neg-enabled", type=str)
    parser.add_argument("--w-neg-shot-capacity", type=int)
    parser.add_argument("--w-neg-alpha", type=float)
    parser.add_argument("--w-neg-beta", type=float)
    parser.add_argument("--w-neg-entropy-threshold-lower", type=float)
    parser.add_argument("--w-neg-entropy-threshold-upper", type=float)
    parser.add_argument("--w-neg-mask-threshold-lower", type=float)
    parser.add_argument("--w-neg-mask-threshold-upper", type=float)
    parser.add_argument("--w-pos-temperature", type=float)
    parser.add_argument("--w-neg-temperature", type=float)

    # Lambda
    parser.add_argument("--use-cache", type=str)
    parser.add_argument("--lambda-object", type=float)
    parser.add_argument("--lambda-id", type=float)
