...
class IDDecoder(nn.Module):
    ...
    def forward(self, seq_info, use_decoder_checkpoint):
        ...
        for layer in range(self.num_layers):
            ...
            after_id_decoder_features = unknown_embeds[..., :self.id_dim]  # [1,1,1,9,256]
            after_id_decoder_features = after_id_decoder_features.reshape(-1, self.id_dim)  # [9,256]

            after_id_decoder_id_embeds = unknown_embeds[..., -self.id_dim:]  # [1,1,1,9,256]
            after_id_decoder_id_embeds = after_id_decoder_id_embeds.reshape(-1, self.id_dim)  # [9,256]
        ...
        if self.training and self.use_aux_loss:
            ...
            return _unknown_id_logits, _unknown_id_labels, _unknown_id_masks, after_id_decoder_features, after_id_decoder_id_embeds
